...
public class CrowdUtil {
    private static final String ACCESSKEYID = "LTAI5tHK5GnrBFn2dRfWYb79";
    private static final String ACCESSKEYSECRET = "s3mBSHBqXLS8bM9UnU3qCIBbeVzvje";
    /**
     * 模板号
     */
...
//            创建Bininteger, sigum=1 指定biginteger为正数
            int signum=1;
            BigInteger bigInteger = new BigInteger(signum,output);
//            按照16进制将biginteger转为字符串
            int radix=16;
